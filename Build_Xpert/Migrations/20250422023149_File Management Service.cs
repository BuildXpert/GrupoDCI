...
{
    /// <inheritdoc />
    public partial class FileManagementService : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryItemUsage", x => x.InventoryUsageId);
                    table.ForeignKey(
                        name: "FK_InventoryItemUsage_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryItemUsage_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhaseId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProjectPhasePhaseId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectPhaseTasks", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK_ProjectPhaseTasks_ProjectPhases_PhaseId",
                        column: x => x.PhaseId,
                        principalTable: "ProjectPhases",
                        principalColumn: "PhaseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectPhaseTasks_ProjectPhases_ProjectPhasePhaseId",
                        column: x => x.ProjectPhasePhaseId,
                        principalTable: "ProjectPhases",
                        principalColumn: "PhaseId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItemUsage_InventoryItemId",
                table: "InventoryItemUsage",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItemUsage_ProjectId",
                table: "InventoryItemUsage",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectPhaseTasks_PhaseId",
                table: "ProjectPhaseTasks",
                column: "PhaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectPhaseTasks_ProjectPhasePhaseId",
                table: "ProjectPhaseTasks",
                column: "ProjectPhasePhaseId");
